    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
          ...
          sm:data-[side=left]:w-[700px]
          sm:data-[side=right]:w-[700px]

          lg:data-[side=left]:w-[820px]
          lg:data-[side=right]:w-[820px]

          xl:data-[side=left]:w-[900px]
          xl:data-[side=right]:w-[900px]
          `,
          className,
        )}
        {...props}
